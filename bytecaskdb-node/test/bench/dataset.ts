// Shared dataset generation for test/bench/*.bench.ts. Mirrors the key
// format, value size, batch size, and range length used by
// benchmarks/engine_bench.cpp (the native C++ benchmark) so results are at
// least directionally comparable to the numbers in the root README.
...
export function generatePrefixedKeys(n: number): string[] {
