...
target("bytecask")
    set_kind("binary")
    add_files("src/*.cpp", "src/engine/*.cppm", "src/engine/bytecask.cpp")
...
target("bytecask_tests")
    set_kind("binary")
    add_files("tests/*.cpp", "src/engine/*.cppm", "src/engine/bytecask.cpp")
...
target("bytecask_bench")
    set_kind("binary")
    set_default(false)
    add_files("benchmarks/map_bench.cpp", "src/engine/*.cppm", "src/engine/bytecask.cpp")
...
target("engine_bench")
    set_kind("binary")
    set_default(false)
    add_files("benchmarks/engine_bench.cpp", "src/engine/*.cppm", "src/engine/bytecask.cpp")
    add_cxflags("-Wno-global-constructors")
