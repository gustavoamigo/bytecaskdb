#!/usr/bin/env python3
"""Build bytecask_bench (map_bench.cpp) in release mode, run it, and append
...
def run_benchmark(extra_flags: list[str]) -> dict:
        ...
        for bench in data["benchmarks"]:
            ...
            row = {
                **common,
                ...
                "bytes_total": bench.get("bytes_total", ""),
                "bytes_per_key": bench.get("bytes_per_key", ""),
            }
            writer.writerow(row)
...
def main() -> None:
    ...
    data = run_benchmark(extra_flags)
